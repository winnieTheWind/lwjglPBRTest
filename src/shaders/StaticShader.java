...
public class StaticShader extends ShaderProgram{
	...
	public void loadNumberOfRows(int nb) { super.loadFloat(location_numberOfRows, nb); }
	...
	public void loadViewMatrix(FirstPersonCamera camera){
	...
	public void loadViewMatrix(FieldCamera camera){
		Matrix4f viewMatrix = Maths.createViewMatrix(camera);
		super.loadMatrix(location_viewMatrix, viewMatrix);
	}
